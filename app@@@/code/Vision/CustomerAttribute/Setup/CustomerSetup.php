...
namespace Vision\CustomerAttribute\Setup;
...
class CustomerSetup extends EavSetup {
	...
	public function installCustomerAttributes($customerSetup) {
		...
		$customerSetup->getEavConfig()->getAttribute('customer', 'ttb_id')->setData('is_user_defined',1)
		...
		$customerSetup->getEavConfig()->getAttribute('customer', 'organisation_number')->setData('is_user_defined',1)
										 ->setData('is_required',0)
										 ->setData('default_value','')
										 ->setData('used_in_forms', ['adminhtml_customer', 'customer_account_create', 'customer_account_edit']) 
										 ->save();
