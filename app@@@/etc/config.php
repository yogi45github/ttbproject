...
return [
    'modules' => [
        ...
        'MagestyApps_FixRules' => 0,
        'Meetanshi_Extensions' => 1,
        'Meetanshi_FacebookChat' => 1,
        'Meetanshi_Fixpaymentrule' => 1,
        'Metalcanvas_Sechome' => 1,
        'Temando_Shipping' => 1,
        'Truck_Customerapplication' => 1,
        'Truck_Parts' => 1,
        'Vertex_Tax' => 1,
        'Vision_AjaxInfiniteScroll' => 1,
        'Vision_ContactUsHistory' => 1,
        'Vision_Csp' => 1,
        'Vision_CustomerAttribute' => 1,
        'Vision_CustomerGrid' => 1,
        'Zemez_AjaxCatalog' => 1,
        'Zemez_AjaxSearch' => 1,
        'Zemez_GoogleMap' => 1,
        'Zemez_ThemeOptions' => 1,
        'Zemez_Megamenu' => 1,
        'Zemez_LayoutSwitcher' => 1
    ]
];
