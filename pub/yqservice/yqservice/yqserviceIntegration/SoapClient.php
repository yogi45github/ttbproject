...
use yqservice\yqserviceIntegration\YqserviceException;
...
class SoapClient extends \SoapClient
{
    ...
    public function setSslCert($sslCertPath)
    {
        if (file_exists($sslCertPath)) {
            ...
            throw new YqserviceException("SSLCERT file {$sslCertPath} not found.");
        }
    }
    ...
    public function setSslKey($sslKeyPath)
    {
        if (file_exists($sslKeyPath)) {
            ...
            throw new YqserviceException("SSLKEY file {$sslKeyPath} not foud.");
        }
    }
    ...
    )
    {
        ...
        } catch (YqserviceException $e) { $this->error = $e->getMessage(); }
