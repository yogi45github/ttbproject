...
jQuery(document).ready(function () {
    ...
    jQuery('.show-full-data').click(function(){
        jQuery('#shortdata'+jQuery(this).attr('data')).hide();
        jQuery(this).hide();
        jQuery('#hidebutton'+jQuery(this).attr('data')).show();
        jQuery('#fulldata'+jQuery(this).attr('data')).show();
    })

    jQuery('.hide-full-data').click(function(){
        jQuery('#shortdata'+jQuery(this).attr('data')).show();
        jQuery(this).hide();
        jQuery('#showbutton'+jQuery(this).attr('data')).show();
        jQuery('#fulldata'+jQuery(this).attr('data')).hide();
    })
    ...
    jQuery('.yqservice_zoom').colorbox({
        'href': function () {
        ...
        'width': typeof jQuery('#viewport')[0] !== 'undefined' ? jQuery('#viewport')[0].clientWidth + 50 : '48%',
        'maxHeight': '98%',
        'maxWidth': '98%',
        'opacity': 0.3,
        close: '',
        html: function () {
            rescaleImage(-100, {x: 0, y: 0});
            var result = jQuery('#viewport');
            return result.html();
        },
        onComplete: function () {
...
function glow(name) {
    ...
    if (name) {
        ...
        jQuery('.yqservice_floatunitlist_box').removeClass('g_highlight_glow');
...
jQuery(document).ready(function () {
    jQuery('.yqservice_floatunitlist_box div').hover(
        function () {
            jQuery('div[name="' + jQuery(this).attr('name') + '"]').parent().addClass('yqservice_floatunitlist_box_hover');
        },
        function () {
            jQuery('div[name="' + jQuery(this).attr('name') + '"]').parent().removeClass('yqservice_floatunitlist_box_hover');
        }
    );
    ...
    jQuery(document).ready(function () {
        jQuery('.unitlist-zoom').colorbox({
                ...
                current: 'img {current} from {total}',
                innerWidth: '800px',
                maxWidth: '98%',
                maxHeight: '98%',
                scrolling: true,
    ...
    jQuery('.yqservice_floatunitlist_box').tooltip({
        track: true,
        delay: 0,
        showURL: false,
        fade: 250,
...
jQuery(document).ready(function () {
    ...
    jQuery(document).on('hover', 'tr.g_collapsed', function () {
        ...
        jQuery(wrapper).find('tr[name=' + name + ']').toggleClass('g_highlight_over');
    });
});

var opennedimage = 'yqservice/assets/images/openned.gif';
var closedimage = 'yqservice/assets/images/closed.gif';
jQuery(document).ready(function ($) {
    ...
    jQuery('img.c_rfull').tooltip({
        ...
        fade: 250,
        bodyHandler: function () {
            return '<h3>Type of Interchangeability</h3>fully duplicated';
        }
    });
    jQuery('img.c_rforw').tooltip({
        ...
        fade: 250,
        bodyHandler: function () {
            return '<h3>Type of Interchangeability</h3>Replacement is possible with the indicated duplicate is possible, but reverse replacement is not guaranteed';
        }
    });
    jQuery('img.c_rbackw').tooltip({
        ...
        fade: 250,
        bodyHandler: function () {
            return '<h3>Type of Interchangeability</h3>Replacement NOT possible';
        }
    });
});
...
jQuery(document).on('change', '[name="sortBy"]', function (e) {
    if (e.target.value) {
...
document.addEventListener('DOMContentLoaded', function (evt) {
    (function showPartList () {
        var links = Array.prototype.slice.call(document.querySelectorAll('a.parts-list-icon'));
